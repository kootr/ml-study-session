...
SELECT 
  *
FROM feature
WHERE date >= '2021-04-01' -- Delete '2021-03-21' ~ '2021-03-31' for invalid value in cumulative_persons_fully_vaccinated
  AND date < '2021-12-14'
-- NOTE: Need to update the value of `new_confirmed` to NULL in the last XX days (Model window)
